...
from views_cardapio import *
from views_opcao import *
from views_subcardapio import *
...
urlpatterns = [
    ...
    url(r'^cardapio/(?P<card_id>[0-9]+)/$', CardapioView.as_view(), name="cardapio"),
    ...
    url(r'^subcardapio/(?P<card_id>[0-9]+)/(?P<id>[0-9]+)/$', SubcardapioView.as_view(), name="subcardapio"),
    ...
    url(r'^opcao/(?P<card_id>[0-9]+)/(?P<id>[0-9]+)/$', OpcaoView.as_view(), name="opcao"),
    ...
    url(r'^gerar_item_preco/(?P<card_id>[0-9]+)/(?P<id>[0-9])$', ItemPriceGenerator.as_view(), name="gerar_item_preco"),
]